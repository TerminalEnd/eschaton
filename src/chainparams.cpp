...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Eschaton v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Eschaton values
        ...
        vSeeds.push_back(CDNSSeedData("multiesch.org", "seed.multiesch.org", true));
        vSeeds.push_back(CDNSSeedData("multiesch.org", "seed2.multiesch.org"));
        ...
        //TODO: fix this for eschaton -- plddr
