    ...
    platformStyle(_platformStyle)
{
    ...
    // Eschaton: load fallback font in case Comic Sans is not available on the system
    ...
    // Eschaton: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Eschaton: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Eschaton address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eschaton: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Eschaton addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Eschaton addresses"));
    ...
    openAction->setStatusTip(tr("Open a eschaton: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Eschaton command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Eschaton network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Eschaton"); // default title
